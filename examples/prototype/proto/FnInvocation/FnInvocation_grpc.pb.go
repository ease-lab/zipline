...
func (c *invocationClient) RouteInvocationCall(ctx context.Context, in *InvocationRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/FnInvocationProto.Invocation/RouteInvocationCall", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Invocation_RouteInvocationCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/FnInvocationProto.Invocation/RouteInvocationCall",
	}
...
var Invocation_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "FnInvocationProto.Invocation",
